...
public class cpetool implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		if (arguments != null && arguments.size() > 0) {
			...
			log.info("No Arguments were passed in - must be Imaging or Workflow");
			log.info("E.g. Argument 1 - Workflow");
			log.info("Argument 2 - GetWorkflows");
			log.info("Argument 3 must be Queue Name");
			log.info("Argument 4 must be Parameter Name");
			log.info("Argument 5 must be Parameter Value");
			System.exit(0);
		}
	}
}
