...
set WIISC_URL=%ServerProtocol%://%ServerURL%:%ServerPort%/WIISC/Workflow/ImportConfigXML

REM Launch Command
echo =====================================================
echo 	Importing Configuration XML
echo =====================================================
powershell -f "%SupportFiles%\PostAuthWebPage.ps1" "%WIISCUsername%" "%WIISCPassword%" "%WIISC_URL%"
if ERRORLEVEL 1 exit /b %ErrorLevel%
if ERRORLEVEL 0 echo Import Configuration Successful!
echo.
echo.
